...
const DEFAULT_CATEGORIES = [
  ...
  { key: 'request', label: 'General Request', enabled: true, default_priority: 'normal' },
...
export default function TicketsDashboardPage() {
  ...
  useEffect(() => { load() }, [filterStatus, filterCategory, filterPriority, page])
      ...
      <div className="p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">All tickets across your portfolio</p>
          </div>
          <button
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          >
            ...
            {['open', 'assigned', 'in_progress', 'pending_review', 'resolved', 'closed', 'cancelled'].map(
